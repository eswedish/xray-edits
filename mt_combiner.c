...
void mt_combiner()
  {
    ...
    TH1F *h22 = new TH1F("h22","Z Dist w/ dEdep Weighting in IC", 120, air1_ic, ic_air2);
    TH2D *h23 = new TH2D("h23","XY weighted energy in IC", 300, -30.0, 30.0, 300, -30.0, 30.0);
    TH2D *h24 = new TH2D("h24","XY e- weighted energy in IC", 300, -30.0, 30.0, 300, -30.0, 30.0);

    // d) air 2
    TH1F *h31 = new TH1F("h31","dEdep in Air 2", 250, 0.0, 0.025);
    TH1F *h32 = new TH1F("h32","Z Dist w/ dEdep Weighting in Air 2", 164, ic_air2, air2_fl);
    TH2D *h33 = new TH2D("h33","XY weighted energy in Air 2", 300, -30.0, 30.0, 300, -30.0, 30.0);
    TH2D *h34 = new TH2D("h34","XY e- weighted energy in Air 2", 300, -30.0, 30.0, 300, -30.0, 30.0);

    // e) filter
    TH1F *h41 = new TH1F("h41","dEdep in filter", 250, 0.0, 0.025);
    TH1F *h42 = new TH1F("h42","Z Dist w/ dEdep Weighting in filter", 200, air2_fl, fl_air3);
    TH2D *h43 = new TH2D("h43","XY weighted energy in filter", 300, -30.0, 30.0, 300, -30.0, 30.0);
    TH2D *h44 = new TH2D("h44","XY e- weighted energy in filter", 300, -30.0, 30.0, 300, -30.0, 30.0);

    // f) air 3
    TH1F *h51 = new TH1F("h51","dEdep in Air 3", 250, 0.0, 0.025);
    TH1F *h52 = new TH1F("h52","Z Dist w/ dEdep Weighting in Air 3", 170, fl_air3, air3_samp);
    TH2D *h53 = new TH2D("h53","XY weighted energy in Air 3", 300, -30.0, 30.0, 300, -30.0, 30.0);
    TH2D *h54 = new TH2D("h54","XY e- weighted energy in Air 3", 300, -30.0, 30.0, 300, -30.0, 30.0);

    // g) sample
    TH1F *h61 = new TH1F("h71","dEdep in Sample", 300, 0.0, 0.03);
    TH1F *h62 = new TH1F("h72","Z Dist w/ dEdep Weighting in Sample", 200, air3_samp, samp_bp);
    TH2D *h63 = new TH2D("h73","XY weighted energy in Sample", 300, -30.0, 30.0, 300, -30.0, 30.0);
    TH2D *h64 = new TH2D("h74","XY weighted energy in Sample", 300, -30.0, 30.0, 300, -30.0, 30.0);

    // h) base plate
    TH1F *h71 = new TH1F("h81","dEdep in BP", 300, 0.0, 0.03);
    TH1F *h72 = new TH1F("h82","Z Dist w/ dEdep Weighting in BP", 115, samp_bp, bp_ld);
    TH2D *h73 = new TH2D("h83","XY weighted energy in BP", 300, -30.0, 30.0, 300, -30.0, 30.0);
    TH2D *h74 = new TH2D("h84","XY weighted energy in BP", 300, -30.0, 30.0, 300, -30.0, 30.0);

    // i) lead
    TH1F *h81 = new TH1F("h91","dEdep in Lead", 300, 0.0, 0.03);
    TH1F *h82 = new TH1F("h92","Z Dist w/ dEdep Weighting in Lead", 130, bp_ld, ld_end);
    TH2D *h83 = new TH2D("h93","XY weighted energy in Lead", 300, -30.0, 30.0, 300, -30.0, 30.0);
    TH2D *h84 = new TH2D("h94","XY weighted energy in Lead", 300, -30.0, 30.0, 300, -30.0, 30.0);

    // j) total
    TH1F *h91 = new TH1F("h101","dEdep Tot", 300, 0.0, 0.03);
    ...
    TCanvas *c5 = new TCanvas("Air Gap 3", "Air Gap 3");
    TCanvas *c6 = new TCanvas("Sample", "Sample");
    TCanvas *c7 = new TCanvas("Base Plate", "Base Plate");
    TCanvas *c8 = new TCanvas("Lead", "Lead");
    TCanvas *c9 = new TCanvas("Total", "Total");
